...
public class AttendClassActivity extends BaseActivity implements EliminateContrller.EliminateListener {
    ...
    public void selectLesson(LessonInfoBean lessonInfoBean, CardInfoBean cardInfoBean) {
        eliminateContrller.selectLesson(1, lessonInfoBean.getLessonId(), studentPerson.getUid(), coachPerson.getUid(), "", cardInfoBean.getCardNo(), 1);
    }
    ...
    public void getLessonInfoSuccess(LessonInfoResponse response) {
        ...
        showNewFragment(CourseAttendFragment.class, bundle);
