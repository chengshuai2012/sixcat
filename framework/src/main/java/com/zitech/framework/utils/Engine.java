...
//    public static final int QUALITY_WIFI = 70;
...
//        int quality = NetworkUtil.isWifiEnabled() ? QUALITY_WIFI : QUALITY_NOT_WIFI;
//        int quality = sizeFormat==NORMAL ? 70 : sizeFormat==SMALL?75:;
        int quality = 70;
        if (sizeFormat == LARGE) {
            quality = 70;
        } else if (sizeFormat == SMALL) {
            quality = 75;
        }
        if(tagBitmap==null){
            throw new IOException("load target image error");
        }
