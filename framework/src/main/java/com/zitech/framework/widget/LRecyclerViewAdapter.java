...
//                onLoadListener.onLoad(datas.size() - 1 - viewHolder.getLayoutPosition());//剩余item数
        ...
        if (lOnItemClickListener != null) {
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    AbsOnClickListener(v , layoutPosition);
                }
            });
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    AbsOnLongClickListener(v, layoutPosition);
                    return true;
                }
            });
        }
    ...
    protected void AbsOnClickListener(View v , int position){

    }

    protected void AbsOnLongClickListener(View v , int position){
