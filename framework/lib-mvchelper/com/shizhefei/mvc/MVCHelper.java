...
public class MVCHelper<DATA> {
    ...
    public static ILoadViewFactory loadViewFactory ;
     ...
     * @param factory
     */
    public static void setLoadViewFactory(ILoadViewFactory factory) {
        loadViewFactory = factory;
    }
    ...
    public boolean isLoading() {
        return asyncDataSource != null && cancle != null;
    }
    ...
    public IAsyncDataSource<DATA> getAsyncDataSource() {
    ...
    private OnScrollBottomListener onScrollBottomListener = new OnScrollBottomListener() {
        ...
        public void onScorllBootom() {
            if (autoLoadMore && hasMoreData && !isLoading()) {
                // 如果网络可以用
                if (needCheckNetwork && !NetworkUtil.isNetworkAvailable(context)) {
