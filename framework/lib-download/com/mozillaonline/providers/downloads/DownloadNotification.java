...
//            CharSequence contentTitle, CharSequence contentText, PendingIntent contentIntent)
            ...
            try {
                Method m = Notification.class.getDeclaredMethod("setLatestEventInfo", Context.class, CharSequence.class, CharSequence.class, PendingIntent.class);
                m.setAccessible(true);
                m.invoke(n, mContext, title, caption, PendingIntent.getBroadcast(mContext, 0, intent, 0));
            } catch (Exception e) {
                e.printStackTrace();
            }
